...
Part 1: This was a fun twist to Conway's Game of Life, but with sea cucumbers! I just maintained a 2D array and a copy, made all the `east` cucumbers move first, then all the `south` ones.

Part 2: TBD: gotta finish the other stars first :(.
