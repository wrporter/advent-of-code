...
Woah! I'm really glad I didn't have to come up with my own parsing solution and just used the json unmarshal function in Go.

Part 1: This one had a lot of special logic in traversing the tree of pairs. But following the instructions to the T made this one go smooth otherwise.

Part 2: I just reached for a permutation function I had written in a previous year and looped through each pair of numbers to get the max.
