...
Although all the puzzles have been fairly easy so far, I felt like this one was the easiest. Nice and easy to think through.

### Part 1

1. For each line, parse out the ranges.
2. Add 1 to a counter if one range fits in another.
3. Return the resulting counter.
