...
I woke up and did this one with my kids. We all snuggled no the couch in front of the fireplace. What a cozy morning 😊.

I took longer as I was explaining things to my children. Also because I was setting up an object key for fast indexing when I think it would have been faster with if-else statement chains.

### Part 1

1. Create a key of shape scores.
2. Create a key of outcomes and scores.
3. Sum the score based on shapes and outcomes.

### Part 2

1. Create a key of shape scores.
2. Create a key of shape and outcome choices.
3. Sum the score based on the shapes and outcomes.
