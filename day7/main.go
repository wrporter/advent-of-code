...
import (
	"fmt"
	"github.com/wrporter/advent-of-code-2019/day7/internal/amplify"
...
func main() {
	codeLines, _ := file.ReadFile("./day7/input.txt")
	...
	ac := amplify.New(program)
	maxThrusterSignal := ac.Amplify(5, []int{0, 1, 2, 3, 4})
