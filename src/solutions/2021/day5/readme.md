...
This one mostly just took me a while in figuring the right algorithm for plotting points on a line. For Part 1, I just took a naive approach of using for loops on the horizontal or vertical axes. But of course, I knew what to expect for Part 2, and it was soon revealed. I then leveraged [Bresenham's Line Algorithm](https://en.wikipedia.org/wiki/Bresenham%27s_line_algorithm) to get this.
