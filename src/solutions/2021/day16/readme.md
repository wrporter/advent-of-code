...
Part 1: It was fun to parse the binary data into a packet data structure. It took me forever to fully wrap my mind around all the detailed instructions. I blame my sleepy brain.

Part 2: We then can walk the tree of parsed packets and perform our respective operations.
