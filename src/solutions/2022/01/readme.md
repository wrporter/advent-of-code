...
I forgot about Advent of Code on opening day! 🙀

I also decided to switch to TypeScript this year since my work is primarily in TypeScript now and for fun. So that's why my Part 1 time was so long. I had to set up some initial scaffolding.

After I solved the puzzle, I ended up putting together a template and getting everything running smoothly in my IDE. Time for days ahead!

### Part 1

1. Split lists by 2 new line characters.
2. Sum each list.
